(function ($) {
    ...
    try {
        ...
        $('#input-start-3').daterangepicker({
            ranges: true,
            autoApply: true,
            applyButtonClasses: false,
            autoUpdateInput: false
        },function (start, end) {
            $('#input-start-3').val(start.format('MM/DD/YYYY'));
            $('#input-end-3').val(end.format('MM/DD/YYYY'));
        });
        
        $('#input-start-4').daterangepicker({
            ranges: true,
            autoApply: true,
            applyButtonClasses: false,
            autoUpdateInput: false
        },function (start, end) {
            $('#input-start-4').val(start.format('MM/DD/YYYY'));
            $('#input-end-4').val(end.format('MM/DD/YYYY'));
        });
